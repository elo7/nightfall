package com.elo7.nightfall.di.providers.kafka.tasks;
...
@Task
public class KafkaStreamingIntegrationTask implements StreamTaskProcessor<DataPoint<String>> {

    private static final long serialVersionUID = 2L;
    private static final Logger LOGGER = LoggerFactory.getLogger(KafkaStreamingIntegrationTask.class);
