 ...
 */
public class RelationalDataBaseRDDConsumer<T> implements Serializable {
    ...
    @Inject
    public RelationalDataBaseRDDConsumer(DataBaseConfiguration configuration) {
     ...
     */
    public void apply(JavaRDD<T> rdd, RDBConsumer<T> consumer) {
        if (!rdd.isEmpty()) {
